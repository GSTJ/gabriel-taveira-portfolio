...
export default [
  ...
  },
  {
    ...
    jobDescription: `At X-Team, I work for a fintech company in California called Groundswell, developing a donation platform for businesses and employees. My focus is on the main application, which is built using React Native.
    
    I aim to help people and promote a culture of robust testing to ensure that anyone can safely refactor our code.
    
    As a financial platform, we have implemented various security standards, such as SOC2. I am currently working on a complete platform rewrite, which involves switching from GO to Node.JS stack.`,
  },
  {
    startDate: "2020",
    endDate: "2022",
