...
export const ClientChrome = () => {
  ...
  return (
    <>
      ...
      {/*
        `toast !== null` rather than `Boolean(toast)`: safe-jsx is happy with
        either, but `Boolean()` doesn't narrow, so the spread would stay
        `ToastPayload | null` and `message` would fail to typecheck.
      */}
