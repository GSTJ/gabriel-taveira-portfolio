...
function AnimatedButton({ getInTouch }) {
  return (
    <a
      href="#socials"
    ...
    >
      <div className="h-12 w-full rounded-[0.31rem] bg-gradient-rotate from-pink-500 via-yellow-500 to-rose-500 blur-lg absolute z-[-1] group-hover:blur-xl transition-all" />
    ...
    <div className="flex w-full justify-center">
      <div className="py-20 lg:mx-0 lg:py-32 max-w-2xl text-center items-center flex flex-col">
        <h1 className="text-3xl md:text-5xl flex gap-4 flex-wrap justify-center">
          ...
          <div className="font-bold text-7xl flex sm:gap-4 flex-wrap justify-center">
            <p>{t("hero.name")}</p>
        ...
        <div className="mt-10 flex gap-x-6 lg:justify-start">
          <AnimatedButton getInTouch={t("hero.getInTouch")} />
        </div>
      </div>
    </div>
  );
